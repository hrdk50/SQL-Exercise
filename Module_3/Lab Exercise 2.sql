...
GO
ALTER DATABASE HumanResources ADD FILE (NAME = F0, FILENAME = 'C:\Radixweb\New folder\SQL-Exercise\Module_3\F0.ndf', SIZE = 3MB, FILEGROWTH = 50%) TO FILEGROUP FG0;
GO
ALTER DATABASE HumanResources ADD FILEGROUP FG1
GO
ALTER DATABASE HumanResources ADD FILE (NAME = F1, FILENAME = 'C:\Radixweb\New folder\SQL-Exercise\Module_3\F1.ndf', SIZE = 3MB, FILEGROWTH = 50%) TO FILEGROUP FG1;
GO
ALTER DATABASE HumanResources ADD FILEGROUP FG2
GO
ALTER DATABASE HumanResources ADD FILE (NAME = F2, FILENAME = 'C:\Radixweb\New folder\SQL-Exercise\Module_3\F2.ndf', SIZE = 3MB, FILEGROWTH = 50%) TO FILEGROUP FG2;
GO
ALTER DATABASE HumanResources ADD FILEGROUP FG3
GO
ALTER DATABASE HumanResources ADD FILE (NAME = F3, FILENAME = 'C:\Radixweb\New folder\SQL-Exercise\Module_3\F3.ndf', SIZE = 3MB, FILEGROWTH = 50%) TO FILEGROUP FG3;
GO
