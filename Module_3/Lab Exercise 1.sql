...
ON PRIMARY 
( 
	NAME = N'HR', FILENAME = N'C:\Radixweb\New folder\SQL-Exercise\Module_3\HumanResources.mdf' , SIZE = 55360KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB 
)
LOG ON 
( 
	NAME = N'HR_log', FILENAME = N'C:\Radixweb\New folder\SQL-Exercise\Module_3\HumanResources_log.ldf' , SIZE = 32960KB , MAXSIZE = 2048GB , FILEGROWTH = 10%
);
GO
